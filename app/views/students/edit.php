...
<section class="add-card page">
    <form class="form" method="POST" action="index.php?controller=student&action=update" enctype="multipart/form-data">
        ...
        <label for="name" class="label images">
            <span class="title" style="margin-right: 10px">Old Images</span>
            <?php foreach (explode(',', $student['images']) as $img): ?>
                <img src="/public/<?= $img ?>" width="100" style="margin:5px">
            <?php endforeach; ?><br>
        </label>
