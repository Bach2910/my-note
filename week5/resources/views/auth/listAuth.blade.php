    ...
    <div class="d-flex flex-wrap mt-3">
        @foreach($users as $user)
            <div class="card mb-3 card__main me-3">
                ...
                @endphp
                <div class="card__subtitle">Role: {{ $userRoles->implode(', ') }}</div>
                ...
                <div class="card__wrapper d-flex gap-3">
                    <form action="{{ route('users.changeRole', $user->id) }}" method="POST">
                        @csrf
                        <select name="role" class="card__btn text-center">
                    ...
                    <form action="{{ route('users.destroy', $user->id) }}" method="POST"
                        ...
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="card__btn_1 card__btn-solid_1">🗑️</button>
                    </form>
                </div>
